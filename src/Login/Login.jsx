            ...
            <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 overflow-y-auto">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 font-dm-sans">It's really nice to see you</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        {/* Sign Up Link */}
                        <div className="flex items-center justify-between mt-6 text-sm">
                            <Link to="/signup" className="text-[#FF4D50] hover:text-[#FFA46F] font-medium transition-colors font-dm-sans">
                                Sign up
                            </Link>
